...
$poverty\_rate = \frac{pov\_count}{pov\_total}$: represents the proportion of residents living below the federal poverty threshold within each ZIP Code Tabulation Area
...
In the merged dataset, we included variables: `zipcode`, `year`, `month`, `rat_count_zip_month`, `violation_count_zip_month`, `inspection_count_zip_month`, `total_pop`, `poverty_rate`, `population_density` and `median_household_income`. 
